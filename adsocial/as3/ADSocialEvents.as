package adsocial.as3 {
    ...
    public class ADSocialEvents {
        ...
        private static var _dispatcher:ADSocialEventDispatcher = new ADSocialEventDispatcher();
        ...
        public static function startSession( achievementID:String ):void
        {
            ...
            ADSocialServices.send("events_beginSession", { achievementID: achievementID }, null, null );
        }
        ...
        public static function setNotifications( clip:MovieClip, style:Object ):void
        {
            ...
            ADSocialServices.send("events_setNotifications", args, null, null );
        }
        ...
        public static function startPlay( tag:String = 'gameplay' ):void {
            ADSocialServices.send("events_setRoundID", { tag:String(tag) }, null, null );
        }

        public static function endPlay():void {
            ADSocialServices.send("events_clearRoundID", null, null, null );
        }

        public static function trackEvent( tag:String, value:* = null ):void {
            ADSocialServices.send("events_trackEvent", { tag: tag, value:value }, null, null );
        }
    }
}
